...
(function (t) {
    ...
    var i = t.fn.jquery.split("."), a = parseInt(i[0]), s = parseInt(i[1]), f = 1 > a || 1 == a && 7 > s;
    t.fn.bindFirst = function () {
        var e = t.makeArray(arguments), n = e.shift();
        return n && (t.fn.bind.apply(this, arguments), r(this, n)), this
    }, t.fn.delegateFirst = function () {
        var e = t.makeArray(arguments), n = e[1];
        ...
        var i = t(this), a = "string" == typeof n;
        if (t.fn.on.apply(i, arguments), "object" == typeof e)for (type in e)e.hasOwnProperty(type) && r(i, type, a); else"string" == typeof e && r(i, e, a);
        return i
    })
})(jQuery);