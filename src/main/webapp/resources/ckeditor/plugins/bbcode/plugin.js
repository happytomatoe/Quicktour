...
(function () {
    ...
    var smileyMap = {angel: "(angel)", some40: ":@", hug: "(hug)", beer: "(beer)", blush: "(blush)", bow: "(bow)", punch: "(punch)", u: "(u)", some34: "(^)", call: "(call)", cash: "(cash)", mp: "(mp)", clap: "(clap)", cofee: "(coffee)", some33: "8-)", sad: ";(", dance: "(dance)", devil: "(devil)", doh: "(doh)", some32: "(d)", some31: "|-(", emo: "(emo)", some30: "]:)", flex: "(flex)", F: "(F)", chuckle: "(chuckle)", handshake: "(handshake)", happy: "(happy)", h: "(h)", wave: "(wave)", inlove: "(inlove)", wasntme: "(wasntme)", envy: "(envy)", some21: ":*", some20: ":D", e: "(e)", makeup: "(makeup)", mm: "(mm)", article: "(~)", music: "(music)", some50: "8-|", ninja: "(ninja)", n: "(n)", nod: "(nod)", x: ":x", party: "(party)", pi: "(pi)", puke: "(puke)", rain: "(rain)", rofl: "(rofl)", sad2: ":(", shake: "(shake)", some1: "|-)", some2: ":)", smirk: "(smirk)", some3: ":-|", some4: "(*)", sun: "(sun)", sweat: "(sweat)", talk: "(talk)", think: "(think)", o: "(o)", yawn: "(yawn)", p: ":p", wait: "(wait)", whew: "(whew)", some10: ";)", some11: ":^)", some12: ":S", some13: "(y)", text: "ASCII text", bandit: "(bandit)", bug: "(bug)", drunk: "(drunk)", fubar: "(fubar)", headbang: "(headbang)", mooning: "(mooning)", poolparty: "(poolparty)", rock: "(rock)", smoking: "(smoking) or (ci)", heidy: "(heidy)", swear: "(swear)", tmi: "(tmi)", toivo: "(toivo)" },
        smileyReverseMap = {},
        smileyRegExp = [];
