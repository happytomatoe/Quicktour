      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="breadcrumb row">
            ...
            <div class="col-sm-4">
              Order ID: <b>${order.id}</b>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;Tour ID: <b>${order.tourInfoId.tourId}</b>
              <div id="customerRating" rel="popover">
                Rated by customer: <span id="rate_${order.id}"></span>
              </div>
            ...
            <div class="col-sm-5 center">
              <span class="tour-name"><a href="/tour/${order.tourInfoId.tour.tourId}" target="_blank">${order.tourInfoId.tour.name}</a></span>
            </div>
              ...
              <div id="collapseOne" class="height0 panel-collapse collapse">
                <div class="panel-body">
                  ...
                  <div class="col-sm-3 no_margin_left">
                    <a href="#" id="tourPhoto"><img src="/img/${order.tourInfoId.tour.mainPhotoUrl}" class="img-thumbnail"></a>
                  </div>
                  ...
                  <div class="col-sm-3 pt-10">
                    ...
                    <div class="form-group">
                      ...
                      <span id="startingDate">${order.tourInfoId.startDate}</span>
                    </div>

                    <div class="form-group">
                      <label>Tour ends on:</label>&nbsp;&nbsp;
                      <span id="endingDate">${order.tourInfoId.endDate}</span>
                    </div>
                    ...
                    <script type="text/javascript">
                      jQuery('#rateTour').raty({
                        ...
                        score: ${ordersService.getRatio(order.tourInfoId.tour.tourId)},
                        number: 5
                      });
                    </script>
                  ...
                  <c:set var="description" value="${order.tourInfoId.tour.description}"/>
                  ...
                  <div class="col-sm-6 no_margin_left pt-10">
                    ${description}...
                    <a href="/tour/${order.tourInfoId.tour.tourId}" target="_blank" title="More..." class="btn btn-default btn-xs">&raquo;</a>
                  </div>

                </div>
              </div>
            </div><!-- /Panel TourInfo Details -->

          <!-- Form Manage Order -->
          <form:form role="form" method="post" modelAttribute="order" id="manageOrderForm" action="/manageOrder/${order.id}">
                    ...
                    <fieldset>
                      <legend>Additional Information</legend>
                        <div class="form-group">
                          ...
                          <textarea name="userInfo" id="comments" rows="5" class="form-control">${order.userInfo}</textarea>
                          <c:if test="${user.roleId.roleId == 3}">
            ...
            </div><!-- /Panel Customer Information -->
              ...
              <div class="panel-heading">
                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTree">
                  <span class="panel-title"><span class="glyphicon glyphicon-hand-right"></span>&nbsp;&nbsp;
                    <c:out value="${user.roleId.roleId != 3 ? 'Manage Order': 'Order Information'}"/>
                  </span>
                </a>
              </div>
                  ...
                  <div class="col-sm-2 no_margin_left">
                    <fieldset>
                      <div class="form-group">
                        ...
                        <c:choose>
                          <c:when test="${user.roleId.roleId == 3}">
                      ...
                      <fieldset>
                        <div class="form-group">
                          ...
                          <c:choose>
                            ...
                            <c:otherwise>
                              <input name="discount" id="discount" value="${order.discount}" class="form-control" type="text">
                            </c:otherwise>
                          </c:choose>
