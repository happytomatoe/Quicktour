...
<div class="row col-md-6" style="align:center">
    <form:form commandName="company" name="company" id="registrationForm" modelAttribute="company" method="POST" cssClass="form-signin"
            ...
            <fieldset>
                <div class="form-group">
                    ...
                    <p><form:label name="address" path="address" cssClass="form-signin-heading">Address*</form:label>
                        <form:input name="address" id="address" path="address" size="30" maxlength="30" cssClass="form-control"
                    ...
                    <p><form:label name="license" path="license" cssClass="form-signin-heading">License*</form:label>
                        <form:input name="license" id="license" path="license" size="30" maxlength="30" cssClass="form-control"
                                    placeholder="Enter company license" required="true"/>
                        <form:errors path="license" cssClass="alert-danger"/></p>

                    <p><form:label name="contactEmail" path="contactEmail" cssClass="form-signin-heading">Email*</form:label>
                        <form:input name="contactEmail" id="contactEmail" path="contactEmail" size="30" maxlength="30" cssClass="form-control"
                                    placeholder="Input company contact email" required="true" type="email"/>
                        <form:errors path="contactEmail" cssClass="alert-danger"/></p>

                    <p><form:label name="contactPhone" path="contactPhone" cssClass="form-signin-heading">Phone:*</form:label>
                        <form:input name="contactPhone" id="contactPhone" path="contactPhone" size="30" maxlength="30" cssClass="form-control"
                                    placeholder="Input company contact phone" required="true"/>
                        <form:errors path="contactPhone" cssClass="alert-danger"/></p>

                    <p><form:label name="discountAmount" path="discountAmount" cssClass="form-signin-heading">Discount:*</form:label>
                        <form:input name="discountAmount" id="discountAmount" path="discountAmount" size="30" maxlength="30" cssClass="form-control"
                    ...
                    <p><form:label name="companyCode" path="companyCode" cssClass="form-signin-heading">Company Code:*</form:label>
                        <div class="input-group">
                            ...
                            <button class="btn btn-default" id="generateCode" type="button" onclick="generate()">Generate!</button>
                            </span>
                        <form:input name="companyCode" id="code" path="companyCode" size="30" maxlength="30" cssClass="form-control"
                    ...
                    <p> <form:select path="type" name="type" class="form-control">
