...
--
-- Хост: 127.0.0.1
-- Час створення: Лют 16 2014 р., 15:01
...
(37, '2013-12-28 15:05:06', 2, 3, 'User info 28', '2100.00', '15.00', '2014-01-05', 'COMPLETED', 5, 1, 8, '2013-12-29 00:00:00', '2014-01-02 00:00:00', '2014-01-06 00:00:00', NULL, 5, ''),
  ...
  (44, '2013-12-29 18:11:25', 4, 2, 'User info 35', '2250.00', '5.00', NULL, 'RECEIVED', 5, 1, 7, NULL, NULL, NULL,
   NULL, 0, ''),
  (45, '2014-02-15 20:35:39', 1, 0, 'User_info', '10000.00', '15.00', NULL, 'RECEIVED', 1, 2, 7, NULL, NULL, NULL, NULL,
   0, 'tour discount=15<br>Company discount=10<br>'),
  (46, '2014-02-15 20:41:01', 1, 0, 'User_info', '10000.00', '15.00', NULL, 'RECEIVED', 1, 2, 7, NULL, NULL, NULL, NULL,
   0, 'tour discount=15<br>Company discount=10<br>');
...
VALUES
  ...
  (9, 'user3', '2eaf7abd06b27207ef710b08b996454349f8fa2b49021249118cbb83e0b20a3f43cd0bd2a7a907db',
   ...
   1, 'user'),
  (24, 'babkamen', '7d48ec7254d7c889b1c4703bd4c90f42199c023ff23901de07f8224f00bb6e596ad9a552b4bcd56a',
   'babkamen@gmail.com', '380989209098', '2014-02-15 13:14:20', 'Gazda', 'Ivanovych', 21, 'Male', '', 36, 1, 'admin');
